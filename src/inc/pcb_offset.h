...
#define PCB_PMPCFG0 (REGBYTES * 32)
#define PCB_PMPADDR0 (REGBYTES * 33)
#define PCB_PMPADDR1 (REGBYTES * 34)
#define PCB_PMPADDR2 (REGBYTES * 35)
#define PCB_PMPADDR3 (REGBYTES * 36)
#define PCB_PMPADDR4 (REGBYTES * 37)
#define PCB_PMPADDR5 (REGBYTES * 38)
#define PCB_PMPADDR6 (REGBYTES * 39)
#define PCB_PMPADDR7 (REGBYTES * 40)
